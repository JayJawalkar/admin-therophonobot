...
// import 'package:cloud_firestore/cloud_firestore.dart'; // Add this package to your pubspec.yaml

// class AddPathwayGameScreen extends StatefulWidget {
//   const AddPathwayGameScreen({super.key});

//   @override
//   State<AddPathwayGameScreen> createState() => _AddPathwayGameScreenState();
// }

// class _AddPathwayGameScreenState extends State<AddPathwayGameScreen> {
...
//     if (_gameEmoji == null) {
//       setState(() {
//         _errorMessage = 'Please select an emoji for the game';
//       });
//       return;
//     }
...
//           .set({
//             'name': gameName,
//             'emoji': _gameEmoji, // Store the emoji
//             'description': _descriptionController.text.trim(), // Store the description
//             'items': itemsWithUrls,
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Create New Game in Pathway'),
//         centerTitle: true,
//         elevation: 0,
//         actions: [
//           if (_gameItems.isNotEmpty || _gameEmoji != null || _gameNameController.text.isNotEmpty)
//             IconButton(
