...
class ApproveTherapistsScreen extends StatefulWidget {
  const ApproveTherapistsScreen({super.key});

  @override
  State<ApproveTherapistsScreen> createState() =>
      _ApproveTherapistsScreenState();
}

class _ApproveTherapistsScreenState extends State<ApproveTherapistsScreen> {
  @override
  Widget build(BuildContext context) {
